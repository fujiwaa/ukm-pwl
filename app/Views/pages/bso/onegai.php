        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">ONEGAI SHELTER</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Onegai Shelter adalah sebuah forum di Universitas Amikom Yogyakarta yang merangkul kawan-kawan yang memiliki minat dalam budaya Jepang-Korea. Disini kawan-kawan akan belajar dan berkreasi bersama. Di Onegai Shelter, Terdapat 4 kelas yang dapat diikuti. Pertama, ada Kelas Byoga yang dimana kita akan belajar untuk membuat karya ilustrasi 2 dimensi. Kedua, Ada Kelas Animasi yang kita akan belajar dalam membuat animasi baik itu 2D atau 3D. Ketiga, Ada Kelas VFX yang belajar dalam membuat efek visual dalam sebuah video atau film. Keempat, Ada Kelas Crafting yang kita membuat karya fisik seperti hiasan. Tujuan dari Onegai Shelter adalah agar dapat mengembangkan bakat anggota yang sudah atau tidak pernah diajarkan oleh kampus dan mengumpulkan mahasiswa yang memiliki hobi unik dan lainnya.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 4</h3>
                    <h3 class="ms-5">No. 26</h3>
                </div>  
