        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HIMASI</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Himpunan Mahasiswa Program Studi Sistem Informasi Universitas Amikom Yogyakarta yang disingkat dengan HIMASI berdiri sejak tanggal 21 Agustus 2022. Awalnya HIMASI bernama Himpunan Mahasiswa Program Studi Manajemen Informatika dan Sistem Informasi (HIMMSI). HIMASI bertujuan untuk menyalurkan aspirasi mahasiswa Program Studi Sistem Informasi di Universitas Amikom Yogyakarta. HIMASI berkedudukan dimana kampus Universitas Amikom Yogyakarta berada, dan akan tetap berdiri selama masih ada mahasiswa Program Studi Sistem Informasi.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 4</h3>
                    <h3 class="ms-3">No. 21</h3>
                </div>  
