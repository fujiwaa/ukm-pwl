        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HIMIKA</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>HIMIKA singkatan dari Himpunan Mahasiswa Ilmu Komunikasi dari Universitas Amikom Yogyakarta yang dibentuk pada 5 Oktober 2017. HMIKA memiliki tujuan sebagai wadah bagi mahasiswa/I ilmu komunikasi Amikom untuk mengembangkan minat dan bakat serta menjadi penghubung intra dan antar kampus dalam bidang Ilmu Komunikasi.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 4</h3>
                    <h3 class="ms-3">No. 25</h3>
                </div>  
