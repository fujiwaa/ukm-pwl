    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="image-org text-center">
                <img src="<?= base_url('img/himpunan/himip.jpg') ?>" alt="himip">
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HIMIP</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Himip merupakan singkatan dari himpunan mahasiswa ilmu pemerintahan berdiri pada tahun 2018 berada dibawah naungan prodi ilmu pemerintahan universitas amikom Yogyakarta. Yang menjadi bagian wadah bagi mahasiswa ilmu pemerintahan untuk mengembangkan hardskill atau pun softskill serta penyaluran aspirasi kepada Lembaga universitas amikom Yogyakarta di himip ini juga kita merangkul satu sama lain layak nya keluarga dan belajar akan banyak hal.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-3">No. 8</h3>
                </div>  
