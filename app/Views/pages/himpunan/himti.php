        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HIMTI</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Wadah untuk mahasiswa Teknologi Informasi untuk melakukan aktivitas 5N+2M (Ngegambar, Nganimasi, Ngefek, Ngedit, Ngerender, Mrogram, Maagh) dengan tujuan untuk meningkatkan kualitas potensi minat bakat mahasiswa TI secara akademik dengan fasilitas yang ada sehingga dapat langsung bekerja dengan standar industri yang ada.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 4</h3>
                    <h3 class="ms-3">No. 24</h3>
                </div>  
