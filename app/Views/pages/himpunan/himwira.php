        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HIMWIRA</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Himpunan Kewirausahaan merupakan sebuah oraganisasi progam studi kewirausahaan Universitas Amikom Yogyakarta yang bertujuan untuk memperkenalkan terkait dunia wirausaha yang kompetetif berlandaskan tri darma perguruan tinggi yang berbudaya dan berwawasan dunia.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-3">No. 2</h3>
                </div>  
