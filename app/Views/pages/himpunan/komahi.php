        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">KOMAHI</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
                <div class="desc-org">
                    <p>KOMAHI merupakan himpunan bagi mahasiswa Hubungan Internasional di Universitas Amikom Yogyakarta. KOMAHI bertujuan untuk mendorong dan mewadahi mahasiswa agar lebih memahami dinamika dalam dunia internasional dengan isu-isu global kontemporer.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 4</h3>
                    <h3 class="ms-3">No. 31</h3>
                </div>  
