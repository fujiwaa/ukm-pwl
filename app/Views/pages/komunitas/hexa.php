    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="image-org text-center">
                <img src="<?= base_url('img/komunitas/hexa.png') ?>" alt="avbc">
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">HEXA</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>HARDWARE EXPERIMENT AMIKOM (HEXA) merupakan sebuah komunitas mahasiswa yang memiliki ketertarikan di bidang Hardware. HEXA memiliki empat divisi yaitu Divisi Hardware, Divisi Robotics, Divisi IoT dan Divisi 3D Print. Adanya HEXA ini diharapkan dapat memberikan wadah bagi mahasiswa khususnya yang mempunyai minat pada bidang explorasi dan pengembangan teknologi.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 2</h3>
                    <h3 class="ms-5">No. 32</h3>
                </div>  
