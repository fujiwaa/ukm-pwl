...
<div class="form-login container">
    ...
    <div class="d-flex justify-content-end mt-4">
        <ul class="sub-judul d-flex justify-content-between">
            <li class="px-4">
                <a href="<?= base_url('login/mahasiswa') ?>" class="fs-5 text-decoration-none text-light">Mahasiswa</a>
            </li>
            <li class="px-4">
    ...
    <form action="<?= site_url('loginorg') ?>" method="POST">
      ...
      <p class="text-end mt-4">Belum punya akun? <span><a href="<?= base_url('register/organisasi') ?>" class="text-light text-decoration-none">Daftar </a></span></p>
    </form>
