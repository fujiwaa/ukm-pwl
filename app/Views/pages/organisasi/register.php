...
<div class="form-login container">
    <div class="d-flex justify-content-end">
        <h1 class="judul-login text-light">Daftar Sebagai</h1>
    </div>
    <div class="d-flex justify-content-end mt-4">
        <ul class="sub-judul d-flex justify-content-between">
            <li class="px-4">
                <a href="<?= base_url('register/mahasiswa') ?>" class="fs-5 text-light text-decoration-none">Mahasiswa</a>
            </li>
            <li class="px-4">
                <a href="" class="org fs-5 px-3 py-2 text-decoration-none border rounded-pill">Organisasi</a>
            </li>
        </ul>
    </div>
    <form action="<?= site_url('registerorg') ?>" method="POST">
      ...
      <p class="text-end mt-4">Sudah punya akun? <span><a href="<?= base_url('login/organisasi') ?>" class="text-light text-decoration-none">Masuk</a></span></p>
    </form>
