        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">AEC</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>AEC atau AMIKOM English Club adalah unit kegiatan mahasiswa bidang keilmuan yang berdiri pada tanggal 20 Januari 2001 yang merupakan kumpulan mahasiswa yang mempunyai minat untuk meningkatkan kemampuan dalam berbahasa Inggris.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-3">No. 13</h3>
                </div>  
