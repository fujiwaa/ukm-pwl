...
<div class="organisasi container justify-content-center">
    <a class="d-flex justify-content-start" href="<?= base_url('ukm') ?>">
    ...
    <div class="row mt-3">
        ...
        <div class="col-md-6">
            <div class="desc-org">
                <p>AMCC atau Amikom Computer Club merupakan UKM di Universitas Amikom Yogyakarta yang berbasis keilmuan dan fokus pada pemrograman komputer. Memiliki visi menjadi “The Best IT Organization in Jogja” dan dengan tagline “Learning by Doing, Learning by Teaching” AMCC memfasilitasi membernya untuk belajar tentang pemrograman komputer dasar hingga mahir. Mulai dari pemrograman web, pemrograman mobile, pemrograman dekstop, hardware software, dan computer network.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-5">No. 15</h3>
                </div>  
