    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="image-org text-center">
                <img src="<?= base_url('img/ukm/lpm-journal.png') ?>" alt="journal">
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">JOURNAL</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Lembaga Pers Mahasiswa Journal merupakan wadah bagi mahasiswa Universitas Amikom Yogyakarta yang memiliki kemauan juga ketertarikan terhadap jurnalistik dan/ berorganisasi.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-5">No. 5</h3>
                </div>  
