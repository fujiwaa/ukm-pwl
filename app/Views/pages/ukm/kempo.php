        ...
        <div class="col-md-6">
            <div class="image-org text-center">
                ...
                <div class="text-center mt-2">
                    <h6 class="mt-4 fs-2 fw-semibold">KEMPO</h6>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="desc-org">
                <p>Shorinji Kempo merupakan salah satu Unit Kegiatan Mahasiswa (UKM) minat bakat yang ada di Universitas Amikom Yogyakarta. Shorinji Kempo sendiri adalah beladiri yang mengajarkan berbagai teknik, mulai dari Goho (Teknik keras) seperti menendang, memukul, dan menangkis, serta Juho (Teknik Lunak) seperti membanting dan mengunci lawan.</p>
                <div class="d-flex justify-content-center mt-4">
                    <h3>Basement 5</h3>
                    <h3 class="ms-5">No. 6</h3>
                </div>  
