...
<ul class="aksi d-flex position-fixed top-0 end-0 mt-2 justify-content-end">
    <li class="text-center px-4 ">
      <a href="<?= base_url('register/mahasiswa') ?>" class="daftar shadow px-4 py-1 position-relative text-decoration-none fs-5 fw-semibold rounded-pill">Daftar</a>
    </li>
    <li class="text-center px-4">
      <a href="<?= base_url('login/mahasiswa') ?>" class="masuk shadow px-4 py-1 position-relative text-white text-decoration-none fs-5 fw-semibold rounded-pill">Masuk</a>
    </li>
</ul>
